...
The analysis of the raw data yielding the quantitative information constitutes an entire course in itself and is not detailed here. Many bioinformatic environments allow the processing of proteomics data, each coming with specific features and different levels of user friendliness. An inexhaustive list is provided in Table 1.

| Tool | Usage | Comment |
| ---- | ----- | ------- |
| [MaxQuant+Perseus](maxquant.org) | Untargeted quantification | Tools for quantificaion and post-processing of untargeted proteomics data. |
