...
tStatisticHistogramPlot <- tStatisticHistogramPlot + geom_line(aes(x=xDistribution, yDistributionTNorm2), col="red", alpha = 0.8)
...
fdrPlot <- ggplot()
fdrPlot <- fdrPlot + geom_point(aes(x=tNormScore, y=fdrPercent), size = 1, alpha=0.5, col = "blue")
fdrPlot <- fdrPlot + geom_point(aes(x=tNormScore, y=correctedFdrPercent, col=regulationConfidence), size = 1, alpha=0.5)
