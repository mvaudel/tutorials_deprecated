...
qqPlot <- ggplot()
qqPlot <- qqPlot + geom_point(aes(x=expectedPValuesLog, y=measuredPValuesLog), size = 1, col = "blue")
qqPlot <- qqPlot + geom_line(aes(x=expectedPValuesLog, y=expectedPValuesLog), size = 1, alpha = 0.5, linetype = "dotted")
qqPlot <- qqPlot + geom_line(aes(x=expectedPValuesLog, y=limitLow), size = 1, alpha = 0.5, linetype = "dotted", col="red")
qqPlot <- qqPlot + geom_line(aes(x=expectedPValuesLog, y=limitHigh), size = 1, alpha = 0.5, linetype = "dotted", col="red")
qqPlot <- qqPlot + xlab("Expected p-value [-log10(p)]") + ylab("Observed p-value [-log10(p)]")
plot(qqPlot)
```
